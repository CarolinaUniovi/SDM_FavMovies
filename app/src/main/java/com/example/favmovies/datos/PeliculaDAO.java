...
public interface PeliculaDAO {
    ...
    @Query("SELECT * FROM peliculas WHERE categoria_nombre = (:nombreCategoria)")
    Pelicula findByCategoria(String nombreCategoria);

    @Transaction
    @Query("SELECT * FROM peliculas WHERE id = (:peliculaId)")
    PeliculaConReparto getPeliculaConReparto(int peliculaId);
